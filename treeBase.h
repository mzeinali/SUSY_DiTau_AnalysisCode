...
// Sun Oct 23 12:36:26 2016 by ROOT version 6.06/01
// from TTree tree/H2TauTauTreeProducerTauTau
// found on file: getMT2Hemi/tree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("getMT2Hemi/tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("getMT2Hemi/tree.root");
      }
